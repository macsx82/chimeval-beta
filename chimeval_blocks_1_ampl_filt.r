...
# path_folder <- "/home/cocca/analyses/michelangelo/chimerismo/20AMP"
...
# all_set <- c("R_D_D","D_R_R","R_D_C01")
all_set <- c(data_set)

base_path_folder <- "/home/cocca/analyses/michelangelo/chimerismo/20AMP/trimmed_reads/sorted_bam/100bp_length/extract_regions"
outfolder <- paste(base_path_folder,"/chimeval_blocks_",mode_set,sep="")

for (samples_set in all_set){
    # samples_set <- all_set[5]

FromAccetor_blocks<-matrix(ncol=1,nrow=dim(ampl_list)[1],data=NA)
rownames(FromAccetor_blocks)<-(ampl_list[,1])

#we will work by amplicon
for (j in 1:dim(ampl_list)[1]) {
    ampl <- ampl_list[j,1]

path_folder <- paste("/home/cocca/analyses/michelangelo/chimerismo/20AMP/trimmed_reads/sorted_bam/100bp_length/extract_regions/",ampl,sep="")
# outfolder <- paste(path_folder,"/chimeval_blocks",sep="")
bamfileDonor=paste(path_folder,"/Don.bam",sep="")
bamindexfileDonor=paste(path_folder,"/Don.bam.bai",sep="")
bamfileAcceptor=paste(path_folder,"/RIC_40amp.bam",sep="")
bamindexfileAcceptor=paste(path_folder,"/RIC_40amp.bam.bai",sep="")
bamfileChimer_01=paste(path_folder,"/chimera_01.bam",sep="")
bamindexfileChimer_01=paste(path_folder,"/chimera_01.bam.bai",sep="")
bamfileChimer_1=paste(path_folder,"/chimera_1.bam",sep="")
bamindexfileChimer_1=paste(path_folder,"/chimera_1.bam.bai",sep="")

# bamfileDonor=paste(path_folder,"/Don_extracted_reg_chr17:70908850-70908851.bam",sep="")
# bamindexfileDonor=paste(path_folder,"/Don_extracted_reg_chr17:70908850-70908851.bam.bai",sep="")
# bamfileAcceptor=paste(path_folder,"/RIC_40amp_extracted_reg_chr17:70908850-70908851.bam",sep="")
# bamindexfileAcceptor=paste(path_folder,"/RIC_40amp_extracted_reg_chr17:70908850-70908851.bam.bai",sep="")
# bamfileChimer_01=paste(path_folder,"/chimera_01_extracted_reg_chr17:70908850-70908851.bam",sep="")
# bamindexfileChimer_01=paste(path_folder,"/chimera_01_extracted_reg_chr17:70908850-70908851.bam.bai",sep="")
# bamfileChimer_1=paste(path_folder,"/chimera_1_extracted_reg_chr17:70908850-70908851.bam",sep="")
# bamindexfileChimer_1=paste(path_folder,"/chimera_1_extracted_reg_chr17:70908850-70908851.bam.bai",sep="")
